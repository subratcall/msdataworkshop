...
# cwalletobjecturi is created and added to atpaqadmin-deployment-${CURRENTTIME}.yaml
# adding other values in atpaqadmin-deployment-${CURRENTTIME}.yaml as parsed from tnsnames.ora(s)
