...
public class JDBCConnectionResource {
  ...
  static {
    System.out.println("JDBCConnectionResource.static oracle.ucp.jdbc.PoolDataSource.atp1.password:" +
            System.getenv("oracle.ucp.jdbc.PoolDataSource.atp1.password"));
  }
